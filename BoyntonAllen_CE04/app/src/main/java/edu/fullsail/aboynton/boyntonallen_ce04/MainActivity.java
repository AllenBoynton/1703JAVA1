...
//        int[][] gameNumbers = new int[][]{gameNumbers1, gameNumbers2, gameNumbers3};
        ...
        try {
            sudokuBoard1 = new SudokuBoard(sudokuBoard1.getNumberArrays());
            sudokuBoard2 = new SudokuBoard(sudokuBoard2.getNumberArrays());
            sudokuBoard3 = new SudokuBoard(sudokuBoard3.getNumberArrays());
        } catch (Exception e) {
            e.printStackTrace();
        }
            ...
            public void onClick(View view) {
                ...
                for (int i = 0; i < boardViews.length; ++i) {
                    for (EditText[] boardView : boardViews) {
                        String numbers = boardView[i].getText().toString();
                        if (numbers.isEmpty()) {
                            boardView[i].setText((Arrays.toString(gameNumbers1)));

                            System.out.println();
                            Log.i(TAG, "----> onClick(boardViews.length)" + Arrays.toString(gameNumbers1));
                            System.out.println();
                        } else {
                        ...
                        if (Arrays.deepToString(rowArrays).equals(String.valueOf(gameNumbers1[i])) ||
                                Arrays.deepToString(columnArrays).equals(String.valueOf(gameNumbers1[i])) ||
                                Objects.equals(String.valueOf(sectionArrays[i]), String.valueOf(gameNumbers1[i]))) {
